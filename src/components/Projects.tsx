...
export default function Projects() {
	...
	const projects: Project[] = [
		...
		},
		{
			...
			name: '420Portal: Weed & Dispensaries GER',
			tech: 'Ionic, Android, iOS, Angular, Capacitor',
		...
		},
		{
			...
			tech: 'Angular, TypeScript, Java, Spring, Oracle, Admin Dashboard',
			demo_link: '#',
